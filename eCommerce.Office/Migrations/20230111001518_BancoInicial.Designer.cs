...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20230111001518_BancoInicial")]
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorSetor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5635), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 1,
                            ColaboradorId = 6,
                            Criado = new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5661), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 5,
                            Criado = new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5664), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 2,
                            ColaboradorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5666), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 3,
                            ColaboradorId = 7,
                            Criado = new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5668), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5670), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            SetorId = 4,
                            ColaboradorId = 3,
                            Criado = new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5672), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
