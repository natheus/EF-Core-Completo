    ...
    public partial class BancoInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5635), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 6, 1, new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5661), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 4, 2, new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5666), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 5, 2, new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5664), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 7, 3, new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5668), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 2, 4, new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5670), new TimeSpan(0, -3, 0, 0, 0)) },
                    { 3, 4, new DateTimeOffset(new DateTime(2023, 1, 10, 21, 15, 17, 554, DateTimeKind.Unspecified).AddTicks(5672), new TimeSpan(0, -3, 0, 0, 0)) }
                });
